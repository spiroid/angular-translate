    ...
    function ($log, $injector, $rootScope, $q) {
      ...
      var getFallbackTranslationInstant = function (langKey, translationId, interpolateParams, Interpolator, sanitizeStrategy) {
        ...
        if (translationTable && Object.prototype.hasOwnProperty.call(translationTable, translationId)) {
          Interpolator.setLocale(langKey);
          result = Interpolator.interpolate(translationTable[translationId], interpolateParams, sanitizeStrategy);
      ...
      var determineTranslationInstant = function (translationId, interpolateParams, interpolationId, uses, sanitizeStrategy) {
        ...
        if (table && Object.prototype.hasOwnProperty.call(table, translationId)) {
          ...
          if (translation.substr(0, 2) === '@:') {
            ...
            result = Interpolator.interpolate(translation, interpolateParams, sanitizeStrategy);
      ...
      $translate.instant = function (translationId, interpolateParams, interpolationId, forceLanguage, sanitizeStrategy) {
        ...
        if (!result && result !== '') {
          if ($notFoundIndicatorLeft || $notFoundIndicatorRight) {
            ...
            result = defaultInterpolator.interpolate(translationId, interpolateParams, sanitizeStrategy);
            if ($missingTranslationHandlerFactory && !pendingLoader) {
